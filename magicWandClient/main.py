...
client.message_callback_add("paulort31@laposte.net/gestion_lumiere", on_lumiere_message)
client.message_callback_add("paulort31@laposte.net/gestion_televiseur", on_televiseur_message)
client.message_callback_add("paulort31@laposte.net/gestion_chaine", on_chaine_message)
